...
def train(args):
    ...
    train_augmentator = RGBSegmentationAug([
        HorizontalFlip(),
        ShiftScaleRotate(scale_limit=(-0.25, 0.25), rotate_limit=0, border_mode=0, p=1),
    ...
    trainset = FFHQHairSegmentation(
        ...
        split='train_real', transform=model_cfg.input_transform, augmentator=train_augmentator
    )
